        ...
        <>
            <div className="w-full max-w-sm">
                <form action="" className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div>
                        <button type="submit" className="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 transition-all">Login</button>
                    </div>
                </form>
            </div>
        </>
